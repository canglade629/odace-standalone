...
@register_pipeline(
    ...
    dependencies=["bronze.siae_structures", "bronze.geo", "silver_v2.dim_commune"],
...
class DimSIAEStructurePipeline(SQLSilverV2Pipeline):
    ...
    def get_name(self) -> str:
        return "silver_v2_dim_siae_structure"
    ...
    def get_sql_query(self) -> str:
        ...
        return """
            ...
            with_commune_sk AS (
                ...
                FROM geo_enriched s
                LEFT JOIN silver_v2_dim_commune c ON s.code_insee = c.commune_code
            ),
            deduplicated AS (
                SELECT *,
                    ROW_NUMBER() OVER (
            ...
            SELECT 
                ...
                'silver_v2_dim_siae_structure' AS job_insert_id,
                CURRENT_TIMESTAMP AS job_insert_date_utc,
                'silver_v2_dim_siae_structure' AS job_modify_id,
